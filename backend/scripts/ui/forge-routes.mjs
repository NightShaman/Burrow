...
export function createForgeRoutes({ store, readJsonBody, sendJson }) {
  return async ({ req, res, url }) => {
    ...
    try {
      ...
      else if (req.method === 'GET' && url.pathname === '/api/forge/jobs') sendJson(res, 200, { ok: true, jobs: await forge.list(agentId) });
