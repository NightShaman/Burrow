...
export type ArchiveDetail = { hasMore?: boolean; nextCursor?: string | null; historyStatus?: 'complete' | 'unavailable'; turns?: SessionTurn[]; chatTurns?: SessionTurn[]; session?: { turns?: SessionTurn[] } };
